            ...
            <div className="panel panel-default">
              ...
              <div className="panel-body">
                ...
                <div className="well">
                  ...
                  <p>DataTables is a very flexible, advanced tables plugin for jQuery. In SB Admin, we are using a specialized version of DataTables built for Bootstrap 3. We have also customized the table headings to use Font Awesome icons in place of images. For complete documentation on DataTables, visit their website at <a target="_blank" rel="noopener noreferrer" href="https://datatables.net/">https://datatables.net/</a>.</p>
                  <a className="btn btn-default btn-lg btn-block" target="_blank" rel="noopener noreferrer" href="https://datatables.net/">View DataTables Documentation</a>
                </div>
              </div>
              {/* <!-- /.panel-body --> */}
            </div>
